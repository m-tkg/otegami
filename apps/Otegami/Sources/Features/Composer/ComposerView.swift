...
struct ComposerView: View {
    ...
    @State var isCcBccExpandedByUser = false
    ...
    #if os(iOS)
    @State var isFormattingBarVisible = ProcessInfo.processInfo.arguments.contains("-uitestsShowFormattingBarDirectly")
    #endif

    /// See `isCcBccExpandedByUser`'s doc comment.
    var isShowingCcBcc: Bool {
    ...
    /// 前置きなしだった)。
    var selectedSignatureLabel: String {
